...
// .wrangler/tmp/bundle-breJpT/checked-fetch.js
...
// functions/api-gateway.js
var api_gateway_default = {
  async fetch(request, env, ctx) {
    ...
    if (url.pathname === "/query" && request.method === "POST") {
      try {
        ...
        console.log("\u{1F50D} D1 Query:", { query, params });
        const stmt = env.PRIMARY_ENGLISH_DB.prepare(query).bind(
          ...params || []
        );
        const data = await stmt.all();
        console.log("\u{1F4CA} D1 Response:", {
          success: true,
...
// .wrangler/tmp/bundle-breJpT/middleware-insertion-facade.js
var __INTERNAL_WRANGLER_MIDDLEWARE__ = [
  middleware_ensure_req_body_drained_default,
  middleware_miniflare3_json_error_default
];
var middleware_insertion_facade_default = api_gateway_default;
...
// .wrangler/tmp/bundle-breJpT/middleware-loader.entry.ts
