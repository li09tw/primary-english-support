    ...
    <div className="min-h-screen bg-white">
      <div className="max-w-4xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-gray-600">生效日期：2024年12月19日</p>
        </div>
        ...
        <div className="prose prose-lg max-w-none">
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-8">
            <p className="text-gray-700 mb-6">
              歡迎您使用 Zs Primary English Support /
              Z的國小英語支援（以下簡稱「本網站」）。我們非常重視您的隱私權，因此制定了本隱私權政策，以說明我們如何收集、使用、保護您的資訊。當您使用本網站時，即表示您同意本政策的內容。
            </p>
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-700 mb-4">我們使用收集到的資訊來：</p>
              <ul className="list-disc pl-6 text-gray-700 space-y-2">
                <li>
            ...
            <section className="mb-8">
              ...
              <div className="mb-6">
                <h3 className="text-xl font-medium text-[#2b6b7a] mb-3">
                  Google Analytics：
                </h3>
                <ul className="list-disc pl-6 text-gray-700 space-y-2">
                  <li>
                ...
                <ul className="list-disc pl-6 text-gray-700 space-y-2">
                  ...
                  <li>
                    ...
                    <a
                      ...
                      className="text-[#2b6b7a] hover:underline"
                      target="_blank"
