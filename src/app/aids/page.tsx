          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div className="bg-white rounded-lg shadow-md p-6 hover:shadow-lg transition-shadow cursor-pointer">
              <div className="text-center">
                ...
                <Link
                  ...
                  className="block w-full px-4 py-2 bg-teal-500 text-white rounded-lg hover:bg-teal-600 transition-colors text-center"
                >
                  開始遊戲
                </Link>
              </div>
            ...
            <div className="bg-white rounded-lg shadow-md p-6 hover:shadow-lg transition-shadow cursor-pointer">
              <div className="text-center">
                ...
                <Link
                  href="/aids/yes-no-riddle"
                  className="block w-full px-4 py-2 bg-emerald-500 text-white rounded-lg hover:bg-emerald-600 transition-colors text-center"
                >
                  開始遊戲
                </Link>
              </div>
            ...
            <div className="bg-white rounded-lg shadow-md p-6 hover:shadow-lg transition-shadow cursor-pointer">
              <div className="text-center">
                ...
                <Link
                  ...
                  className="block w-full px-4 py-2 bg-rose-500 text-white rounded-lg hover:bg-rose-600 transition-colors text-center"
                >
                  開始遊戲
                </Link>
              </div>
