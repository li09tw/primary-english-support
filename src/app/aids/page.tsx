...
export default function AidsPage() {
  ...
  useEffect(() => {
    ...
    if (savedAids) {
      setTeachingAids(JSON.parse(savedAids));
    } else {
      setTeachingAids(sampleAids);
  ...
  const subjects = [
    "all",
    ...Array.from(new Set(aids.map((aid) => aid.subject))),
  ];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-8 bg-white rounded-lg shadow-md p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="text-center p-4 bg-secondary-pink rounded-lg">
              <h4 className="font-medium text-secondary-pink mb-2">康軒版</h4>
              <p className="text-sm text-secondary-pink">適用於多個年級</p>
            </div>
            <div className="text-center p-4 bg-accent-green rounded-lg">
              <h4 className="font-medium text-accent-green mb-2">翰林版</h4>
              <p className="text-sm text-accent-green">適用於多個年級</p>
            </div>
            <div className="text-center p-4 bg-accent-green rounded-lg">
              <h4 className="font-medium text-accent-green mb-2">南一版</h4>
              <p className="text-sm text-accent-green">適用於多個年級</p>
            </div>
          </div>
        </div>
