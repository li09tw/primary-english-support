...
INSERT INTO game_methods (id, title, description, categories, grade1, grade2, grade3, grade4, grade5, grade6, materials, instructions, created_at, updated_at) 
VALUES ('4', '動物單字學習卡', '包含常見動物的英文單字和圖片，幫助學生學習動物相關的英語詞彙。', '["單字學習"]', true, true, true, false, false, false, '["動物圖片卡","單字卡","音檔"]', '["展示動物圖片，讓學生說出中文名稱","教導對應的英文單字發音","進行單字配對練習","播放音檔讓學生跟讀"]', '2024-01-08T10:00:00.000Z', '2024-01-08T10:00:00.000Z');

INSERT INTO game_methods (id, title, description, categories, grade1, grade2, grade3, grade4, grade5, grade6, materials, instructions, created_at, updated_at) 
VALUES ('5', '顏色句型練習板', '透過顏色主題練習基本句型，如 "What color is it?" 和 "It is..."。', '["句型練習"]', false, true, true, false, false, false, '["顏色卡片","句型提示板","互動白板"]', '["展示不同顏色的物品","教師示範句型：What color is it?","學生回答：It is red/blue/green...","進行角色互換練習"]', '2024-01-05T16:00:00.000Z', '2024-01-05T16:00:00.000Z');

INSERT INTO game_methods (id, title, description, categories, grade1, grade2, grade3, grade4, grade5, grade6, materials, instructions, created_at, updated_at) 
VALUES ('6', '日常對話情境卡', '模擬真實生活情境的對話練習，提升學生的口語表達能力。', '["口語訓練"]', false, false, true, true, true, true, '["情境設定卡","角色扮演道具","對話腳本"]', '["設定對話情境，如：在商店購物","分配角色：店員、顧客","學生根據腳本進行對話練習","鼓勵學生自由發揮和表達"]', '2024-01-03T12:00:00.000Z', '2024-01-03T12:00:00.000Z');
